...
export default class StartGame extends Phaser.Scene
{
    ...
    create()
    {
        ...
        this.add.image(80, 70, 'brick1').setScale(0.2);
        this.add.image(120, 90, 'brick1').setScale(0.2);
        this.add.image(120, 110, 'brick1').setScale(0.2);
        this.add.image(80, 130, 'brick1').setScale(0.2);

        //R
        this.add.image(200, 130, 'brick1').setScale(0.2);
        this.add.image(200, 110, 'brick1').setScale(0.2);
        this.add.image(200, 90, 'brick1').setScale(0.2);
        this.add.image(200, 70, 'brick1').setScale(0.2);
        this.add.image(200, 50, 'brick1').setScale(0.2);
        this.add.image(200, 30, 'brick2').setScale(0.2);
        this.add.image(240, 30, 'brick1').setScale(0.2);
        this.add.image(280, 50, 'brick1').setScale(0.2);
        ...
        this.add.image(400, 70, 'brick1').setScale(0.2);
        this.add.image(400, 50, 'brick4').setScale(0.2);
        this.add.image(400, 30, 'brick1').setScale(0.2);
        this.add.image(360, 130, 'brick1').setScale(0.2);
        ...
        //C
        this.add.image(560, 130, 'brick1').setScale(0.2);
        ...
        this.add.image(520, 70, 'brick1').setScale(0.2);
        this.add.image(520, 50, 'brick1').setScale(0.2);
        ...
        this.add.image(680, 50, 'brick1').setScale(0.2);
        this.add.image(680, 70, 'brick1').setScale(0.2);
        this.add.image(680, 90, 'brick6').setScale(0.2);
        this.add.image(680, 110, 'brick1').setScale(0.2);
        this.add.image(680, 130, 'brick1').setScale(0.2);
        ...
        this.add.image(840, 50, 'brick1').setScale(0.2);
        this.add.image(880, 70, 'brick1').setScale(0.2);
        this.add.image(920, 90, 'brick1').setScale(0.2);
        this.add.image(920, 110, 'brick1').setScale(0.2);
        ...
        //R
        this.add.image(180, 180, 'brick1').setScale(0.2);
        this.add.image(180, 200, 'brick1').setScale(0.2);
        this.add.image(180, 220, 'brick1').setScale(0.2);
        this.add.image(180, 240, 'brick1').setScale(0.2);
        ...
        this.add.image(260, 260, 'brick1').setScale(0.2);
        this.add.image(260, 280, 'brick1').setScale(0.2);

        //E
        this.add.image(320, 180, 'brick1').setScale(0.2);
        ...
        this.add.image(320, 260, 'brick1').setScale(0.2);
        ...
        this.add.image(360, 280, 'brick1').setScale(0.2);
        ...
        this.add.image(460, 260, 'brick1').setScale(0.2);
        this.add.image(460, 280, 'brick1').setScale(0.2);
        this.add.image(540, 200, 'brick2').setScale(0.2);
        this.add.image(540, 220, 'brick1').setScale(0.2);
        this.add.image(540, 240, 'brick1').setScale(0.2);
        ...
        //K
        this.add.image(600, 180, 'brick1').setScale(0.2);
        this.add.image(600, 200, 'brick1').setScale(0.2);
        this.add.image(600, 220, 'brick1').setScale(0.2);
        this.add.image(600, 240, 'brick2').setScale(0.2);
        this.add.image(600, 260, 'brick1').setScale(0.2);
        this.add.image(600, 280, 'brick1').setScale(0.2);
        this.add.image(680, 180, 'brick1').setScale(0.2);
        ...
        this.add.image(740, 200, 'brick1').setScale(0.2);
        ...
        this.add.image(740, 280, 'brick1').setScale(0.2);
        this.add.image(780, 180, 'brick1').setScale(0.2);
        ...
        this.add.image(880, 240, 'brick1').setScale(0.2);
        this.add.image(880, 260, 'brick1').setScale(0.2);
        ...
        this.add.image(960, 260, 'brick1').setScale(0.2);
